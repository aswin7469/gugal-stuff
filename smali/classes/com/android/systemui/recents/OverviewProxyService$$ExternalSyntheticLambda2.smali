...
.method public final onStateChanged(ZZZZZZZ)V
    ...
    .line 18
    invoke-virtual {v2, v3, v4, v1}, Lcom/android/systemui/model/SysUiState;->setFlag(JZ)Lcom/android/systemui/model/SysUiState;
    ...
    .line 28
    invoke-virtual {v2, p1, p2, p6}, Lcom/android/systemui/model/SysUiState;->setFlag(JZ)Lcom/android/systemui/model/SysUiState;

    .line 30
    const-wide p1, 0x80000000L

    .line 33
    invoke-virtual {v2, p1, p2, p3}, Lcom/android/systemui/model/SysUiState;->setFlag(JZ)Lcom/android/systemui/model/SysUiState;

    .line 38
    const-wide/16 p1, 0x8

    .line 41
    invoke-virtual {v2, p1, p2, p4}, Lcom/android/systemui/model/SysUiState;->setFlag(JZ)Lcom/android/systemui/model/SysUiState;

    .line 43
    const-wide/32 p1, 0x200000

    .line 46
    invoke-virtual {v2, p1, p2, p5}, Lcom/android/systemui/model/SysUiState;->setFlag(JZ)Lcom/android/systemui/model/SysUiState;

    .line 49
    const-wide/32 p1, 0x8000000

    .line 52
    invoke-virtual {v2, p1, p2, p7}, Lcom/android/systemui/model/SysUiState;->setFlag(JZ)Lcom/android/systemui/model/SysUiState;
